...
class MUCRoomConfigExtensionManagerTest {
    ...
    void registeredExtensionContributesConfigForm() {
        ...
        // testExtension's processConfigSubmit is a no-op; assert the delegation path runs cleanly.
        assertDoesNotThrow(() -> MUCRoomConfigExtensionManager.getInstance().processConfigSubmit(form, room));
    }
